...
- A page with `pinned: true` in `.usage.json` is **skipped** by every subset variant — full lint, "швидко" top-10, and any user-named scope. It is also **excluded** from any "candidates for content-verification" auto-list.
